// std::regex_iterator를 이용해서 텍스트에 담긴 단어들의 출현 빈도를 세는 예.
#include <regex>
...
int main() {
    ...
    std::string text{ "That's a (to me) amazingly frequent question. \
        It may be the most frequently asked question. Surprisingly, C++0x feels like a new language: \
        The pieces just fit together better than they used to and \
        I find a higher-level style of programming more natural than before and as efficient as ever." };
